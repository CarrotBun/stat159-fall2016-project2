...
Lastly, we ran the regressions on the entire credit data using the best lambda values and got the final coefficient values show in the combined table in Figure # under results. 
...
Lastly, we ran the regressions on the entire credit data to get the final coefficients for each of the regression models (as shown below in Figure #).  
